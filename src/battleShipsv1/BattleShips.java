...
public class BattleShips 
{
	public static void main(String[] args)
	{
		...
		do
		{
			...
			System.out.println("Please input the X position of the back of the first ship (length 2)");
			int x = s.nextInt();
			System.out.println("Please input the Y position of the back of the first ship (length 2)");
			int y = s.nextInt();
